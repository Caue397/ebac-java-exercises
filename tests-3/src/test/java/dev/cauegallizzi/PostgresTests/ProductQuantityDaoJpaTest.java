...
public class ProductQuantityDaoJpaTest {
    ...
    private final IProductQuantityDaoJpa productQuantityDao = new ProductQuantityDaoJpa("postgres");
    private final IProductDaoJpa productDao = new ProductDaoJpa("postgres");
